    ...
    wrap.innerHTML = sets.map(s => `
      <div class="instr-card">
        ...
        <div class="instr-preview">
          ...
          <div class="preview-label" style="margin-top:.6rem">Approved message</div>
          <div class="preview-text">${esc(s.approvedText || '—')}</div>
          ${(s.approvedSteps || []).length
            ? `<div class="preview-label" style="margin-top:.6rem">Steps (${s.approvedSteps.length})</div>
